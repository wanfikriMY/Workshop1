...
<body>
    ...
    <div class="w3-container" style="padding: 50px 16px;" id="about">
        ...
        <div class="w3-dropdown-click">
            <button onclick="myFunction()" class="w3-button w3-light-grey">Select User Type</button>
        ...
        if ($list == 'student') {
        ?>
            <input class="w3-button w3-right w3-light-grey" value="Add Student" onclick="window.location.href='reg-student.php'" />
