            ...
            ?>
                    ...
                    <tr id="<?php echo $evaID; ?>">
                        ...
                        <td><?php $sql4 = "SELECT * FROM `user` WHERE id = '$evaluator2'";
                            ...
                            echo $evaluatorname1 . " (" . $evaluator2 . ")"; ?></br><?php $sql5 = "SELECT * FROM `user` WHERE id = '$evaluator3'";
                                                                                    $resultSql5 = mysqli_query($con, $sql5);
                                                                                    while ($row = mysqli_fetch_assoc($resultSql5)) {
                                                                                        $evaluatorname2 = $row['name'];
                                                                                    }
                                                                                    echo $evaluatorname2 . " (" . $evaluator3 . ")"; ?></td>
                        <td><?php echo "Showcase Mark: " . $mark2 . ", Report Mark: " . $rm2; ?></td>
                        <td><?php echo "Showcase Mark: " . $mark3 . ", Report Mark: " . $rm3; ?></td>
                        <td><?php echo $comment; ?></td>
                        <td><input type="button" value="Delete" onclick="confirmDelete(<?php echo $evaID; ?>)"> </td>
                    </tr>
                <?php
                }
            } else {
...
<script>
    ...
    function confirmDelete(x) {
        var answer = confirm("Are you sure want to delete mark this project " + x + "?");
