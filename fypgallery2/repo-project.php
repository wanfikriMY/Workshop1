    ...
    <div class="w3-center" style="padding:5% 40px" id="contact">
      ...
      <div style="margin-top:48px" class="w3-center">
        ...
        <form action="" method="POST" enctype="multipart/form-data" class="w3-center" style="width:40%;">
          ...
          <p><strong>Project Title</strong><input class="w3-input w3-border" type="text" size="50" name="POT" placeholder="Enter Your Project Title"></p>
          ...
          <p><strong>Awards</strong><input class="w3-input w3-border" name="abstract" id="abstract" cols="50" rows="10" maxlength="3000"></input></p>
