          ...
          <table>
            ...
            ?>
                ...
                <tr>
                  ...
                  <td><a href="https://mail.google.com/mail/?view=cm&fs=1&tf=1&to=<?php echo $emailBit; ?>&su='FYP Supervisor Consultation'&body=" class="w3-button w3-teal"><i class="fa fa-phone-square w3-margin-right"></i>Contact Supervisor</a></td>
                </tr>
              <?php
          ...
          <table>
            ...
            ?>
                <tr>
                  ...
                  <td><a href="https://mail.google.com/mail/?view=cm&fs=1&tf=1&to=<?php echo $emailBCS; ?>&su='FYP Supervisor Consultation'&body=" class="w3-button w3-teal"><i class="fa fa-phone-square w3-margin-right"></i>Contact Supervisor</a></td>
