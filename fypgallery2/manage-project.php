...
<div class="w3-container" style="padding: 50px 16px;" id="about">
    <h3 class="w3-center ">Manage Project</h3>


    <div class="w3-dropdown-click">
        <button onclick="myFunction()" class="w3-button w3-light-grey">Select Project Department</button>
    ...
    ?>
        <table class="active" style="width:100%" id="user" style="overflow-x:auto;">
            ...
            <tbody>
                ...
                ?>
                        <tr>
                            <td><a href='project-description.php?projectID=<?php echo $row['projectID']; ?>'><?php echo $projectID; ?></td>
                            <td><a href='project-description.php?projectID=<?php echo $row['projectID']; ?>'><?php echo $projectName; ?></td>
                            <td><?php echo $projectType; ?></td>
                            <td><?php echo $year; ?></td>
                            <td><?php echo $major; ?></td>
                            <td><a class="w3-button fa fa-wrench" value="Edit " onclick="window.location.href='edit-project.php?projectID=<?php echo $projectID; ?>'"> Edit</a></td>
                            <td><a class="w3-button fa fa-trash" style="color:red" value="Delete" onclick="confirmDelete()"> Remove</a></td>
                        </tr>
                    <?php
                    }
                } else {
            ...
            <tbody>
                ...
                ?>
                        <tr>
                            ...
                            <td><a class="fa fa-trash" style="color:red" aria-hidden="true" value="Delete" onclick="confirmDelete()"></td>
                        </tr>
                    <?php
                    }
                } else {
...
<script>
    ...
    function confirmDelete() {
        ...
        if (answer) {
            window.location.href = "manage-project.php?deleteProjectbit=<?php echo $projectID; ?>";
        } else {}
    }
